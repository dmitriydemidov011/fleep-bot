...
# Railway Volume: создай Volume в Railway и примонтируй к /data
# Без Volume база сбрасывается при каждом деплое!
_data_dir = os.environ.get("RAILWAY_VOLUME_MOUNT_PATH", "/data")
